...
componentDidUpdate() {
  ...
  render() {
    ...
    {this.state.secondsRemaining > 0 && <p className="count"><img src="img/sunset.svg"/>{this.pad(this.state.hoursRemaining)}:{this.pad(this.state.minutesRemaining)}:{this.pad(this.state.secondsRemaining)}</p>}
    {this.state.secondsRemaining < 0 && <p className="count"><img src="img/sunset.svg"/>{this.pad(Math.abs(this.state.hoursRemaining))}:{this.pad(Math.abs(this.state.minutesRemaining))}:{this.pad(Math.abs(this.state.secondsRemaining))}</p>}
      </div>
    )
  }
}
